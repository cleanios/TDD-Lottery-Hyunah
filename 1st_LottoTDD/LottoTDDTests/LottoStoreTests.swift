...
func testFetchExistingUserUser() {
    ...
    let fetchExistingUserExpectation = expectationWithDescription("fetch existing user")
    
    UserEntity.requestUser("5744b138f64cf2021002fa76", accessToken: "fakeAccessToken") { (result) in
...
func testNonexistentUser() {
    ...
    let fetchUserExpectation = expectationWithDescription("fetch nonexistent user")
    
    UserEntity.requestUser("thisWillNeverBeAUserId", accessToken: "fakeAccessToken") { (result) in
...
func testInvalidUser() {
    ...
    let fetchUserExpectation = expectationWithDescription("fetch invalid user data")
    
    UserEntity.requestUser("5744b138f64cf2021002fa77", accessToken: "fakeAccessToken") { (result) in
